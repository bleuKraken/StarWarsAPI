...
function MyRequest() {
  ...
  request.onload = function() {
    ...
    var homePlanets = [
      ["Tatooine", 1],    ["Geonosis", 11],         ["Eriadu", 21],      ["Mon Cala", 31],     ["Tund", 41],         ["Mirial", 51],
      ["Alderaan", 2],    ["Utapau", 12],           ["Corellia", 22],    ["Chandrila", 32],    ["Haruun Kal", 42],   ["Serenno", 52],
      ["name", 3],        ["name", 13],             ["Rodia", 23],       ["Sullust", 33],      ["Cerea", 43],        ["Concord Dawn", 53],
      ["name", 4],        ["Kashyyyk", 14],         ["Nal Hutta", 24],   ["Toydaria", 34],     ["Glee Anselm", 44],  ["Zolan", 54],
      ["name", 5],        ["name", 15],             ["name", 25],        ["Malastare", 35],    ["Iridonia", 45],     ["Ojom", 55],
      ["Bespin", 6],      ["name", 16],             ["Bestine IV", 26],  ["Dathomir", 36],     ["Tholoth", 46],      ["Skako", 56],
      ["Endor", 7],       ["name", 17],             ["name", 27],        ["Ryloth", 37],       ["Iktotch", 47],      ["Muunilinst", 57],
      ["Naboo", 8],       ["Cato Neimoidia", 18],   ["name", 28],        ["Aleen Minor", 38],  ["Quermia", 48],      ["Shili", 58],
      ["Coruscant", 9],   ["name", 19],             ["Trandosha", 29],   ["Vulpter", 39],      ["Dorin", 49],        ["Kalee", 59],
      ["Kamino", 10],     ["Stewjon", 20],          ["Socorro", 30],     ["Troiken", 40],      ["Champala", 50],     ["Umbara", 60],
...
function SearchButtonPressed() {
  ...
  var characterListAPI = [
    ["Luke Skywalker", 1],      ["Anakin Skywalker", 11],      ["Palpatine", 21],              ["Nien Nunb", 31],      ["Sebulba", 41],         ["Mace Windu", 51],    ["Cordé", 61],                ["Dexter Jettster", 71],  ["Raymus Antilles", 81],
    ["C-3PO", 2],               ["Wilhuff Tarkin", 12],        ["Boba Fett", 22],              ["Qui-Gon Jinn", 32],   ["Quarsh Panaka", 42],   ["Ki-Adi-Mundi", 52],  ["Cliegg Lars", 62],          ["Lama Su", 72],          ["Sly Moore", 82],
    ["R2-D2", 3],               ["Chewbacca", 13],             ["IG-88", 23],                  ["Nute Gunray", 33],    ["Shmi Skywalker", 43],  ["Kit Fisto", 53],     ["Poggle the Lesser", 63],    ["Taun We", 73],          ["Tion Medon", 83],
    ["Darth Vader", 4],         ["Han Solo", 14],              ["Bossk", 24],                  ["Finis Valorum", 34],  ["Darth Maul", 44],      ["Eeth Koth", 54],     ["Luminara Unduli", 64],      ["Jocasta Nu", 74],       ["Finn", 84],
    ["Leia Organa", 5],         ["Greedo", 15],                ["Lando Calrissian", 25],       ["Padmé Amidala", 35],  ["Bib Fortuna", 45],     ["Adi Gallia", 55],    ["Barriss Offee", 65],        ["R4-P17", 75],           ["Rey", 85],
    ["Owen Lars", 6],           ["Jabba Desilijic Tiure", 16], ["Lobot", 26],                  ["Jar Jar Binks", 36],  ["Ayla Secura", 46],     ["Saesee Tiin", 56],   ["Dormé", 66],                ["Wat Tambor", 76],       ["Poe Dameron", 86],
    ["Beru Whitesun lars", 7],  ["Hidden Character", 17],      ["Ackbar", 27],                 ["Roos Tarpals", 37],   ["Ratts Tyerell", 47],   ["Yarael Poof", 57],   ["Dooku", 67],                ["San Hill", 77],         ["BB8", 87],
    ["R5-D4", 8],               ["Wedge Antilles", 18],        ["Mon Mothma", 28],             ["Rugor Nass", 38],     ["Dud Bolt", 48],        ["Plo Koon", 58],      ["Bail Prestor Organa", 68],  ["Shaak Ti", 78],
    ["Biggs Darklighter", 9],   ["Jek Tono Porkins", 19],      ["Arvel Crynyd", 29],           ["Ric Olié", 39],       ["Gasgano", 49],         ["Mas Amedda", 59],    ["Jango Fett", 69],           ["Grievous", 79],
    ["Obi-Wan Kenobi", 10],     ["Yoda", 20],                  ["Wicket Systri Warrick", 30],  ["Watto", 40],          ["Ben Quadinaros", 50],  ["Gregar Typho", 60],  ["Zam Wesell", 70],           ["Tarfful", 80],
    ["Captain Phasma", 88]
  ];
  ...
  for (var counter = 0; counter <= characterListAPI.length - 1; counter++) {
    ...
    if (characterSearch === characterListAPI[counter][0]) {
      ...
      alert("I has found the target, I swear!");
      break;
    }
  }
